...
"NAS_UPTIME_BASELINE=$(printf '%q' "$NAS_UPTIME_BASELINE")"$'\n'
  ...
  copy_with_backup "$NAS_ROOT/config/nas-workstation-smart-monitor" "$(target_path /usr/local/sbin/nas-workstation-smart-monitor)"
  run chmod 0755 "$(target_path /usr/local/sbin/nas-workstation-smart-monitor)"
